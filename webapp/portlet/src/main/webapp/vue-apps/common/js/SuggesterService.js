...
export function search(filter) {
  ...
  if (filter.includeGroups) {
    ...
    searchGroups(filter.term, filter.groupMember, filter.groupType, filter.items, filter.errorCallback, filter.allGroupsForAdmin)
...
function searchGroups(filter, groupMember, groupType, items, errorCallback, allGroupsForAdmin) {
  const formData = new FormData();
  formData.append('q', filter);
